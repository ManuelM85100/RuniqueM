...
import com.mmunoz.core.domain.location.LocationTimestamp
...
object PolylineColorCalculator {
    ...
    fun locationsToColor(
        ...
        val distanceMeter = location1.location.location.distanceTo(location2.location.location)
        val timeDiff = abs((location2.durationTimestamp - location1.durationTimestamp).inWholeSeconds)
        val speedKmh = (distanceMeter / timeDiff) * 3.6
